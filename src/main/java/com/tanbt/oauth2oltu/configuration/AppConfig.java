package com.tanbt.oauth2oltu.configuration;
...
@EnableJpaRepositories("com.tanbt.oauth2oltu.repository.mysql")
public class AppConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        entityManagerFactoryBean.setPackagesToScan(env.getRequiredProperty("jpa.entity"));
